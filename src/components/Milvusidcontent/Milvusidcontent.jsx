...
import { getSentiment, getEmail, getSummary, submitQA, fe_getContentFromID } from "../../js/aiCalls";
...
import "./_milvusidcontent.scss";

const Milvusidcontent = () => {
  // sm={4} md={8} lg={16}
  ...
  async function submitQAFromAI() {
    ...
    let getServiceResult = await fe_getContentFromID(id).catch((e) => {
  ...
  return (
    <div>
      <Grid fullWidth className="portal-top-grid ">
        ...
        <Column sm={4} md={8} lg={16}>
          <div style={{ fontWeight: "bold" }}>Display Milvus ID Content</div>
        </Column>
...
export default Milvusidcontent;
